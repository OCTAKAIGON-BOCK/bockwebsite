...
function sento_thinkup_child_frontscripts() {
	...
	wp_enqueue_style( 'sento-thinkup-style-store', get_stylesheet_uri(), array( 'thinkup-style' ), wp_get_theme()->get('Version') );
...
function sento_thinkup_updateoption_child_settings() {
	...
	$name_options_child = $name_theme_lower . '_thinkup_child_settings_store';
	...
	if ( $options_child_settings != 1 ) {
		...
		$options_free['thinkup_styles_skin']        = 'store';
